...
namespace DAL
{
    public static class ConnectionStrings
    {
        ...
        {
            {"localApiVS", "https://localhost:44306/api/Api/"},
            {"localApiConsole", "http://localhost:5000/api/Api/"},
            {"sharedApi", "http://cassiopeia.serveirc.com:5000/api/Api/"}
        };
